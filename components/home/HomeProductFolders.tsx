...
export default async function HomeProductFolders() {
  ...
  return (
    <section id="products" className="section-alt !pt-8 md:!pt-12 !pb-8 md:!pb-12">
      <div className="max-w-7xl mx-auto px-6 space-y-10">
        {HOME_PRODUCT_FOLDERS.map((folder) => {
          const readyCount = folder.productSlugs.filter((s) => bySlug.has(s)).length
                    ...
                    if (!p) {
                      return (
                        ...
                        >
                          ...
                          <div className="mt-2 font-semibold text-white/80 break-words">{slug}</div>
